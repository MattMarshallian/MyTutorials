package com.example.tutorial.marcin.mylibrary.general.containers.contentbands;
...
public class EndlessContentBand extends BasicContentBand {
	...
	public void fling(int velocityX, int velocityY){		
		mTouchState = BasicContentBand.TOUCH_STATE_FLING;
		...
		if(velocityX < 0) {
			mScrollDirection = BasicContentBand.DIRECTION_LEFT;
		}
		else if(velocityX > 0) {
			mScrollDirection = BasicContentBand.DIRECTION_RIGHT;
		}
